...
Текущая версия: **1.5.0** · Min SDK: **26 (Android 8.0)** · Target SDK: **37** · Compile SDK: **37**
...
Production signing отделён от обычного CI веток и pull request. Основной подписанный AAB и дополнительный подписанный APK создаются только workflow Android Release для тега версии, например `v1.5.0`, либо при ручном запуске с явным указанием существующего тега версии.
